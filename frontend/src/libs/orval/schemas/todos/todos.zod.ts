...
export const getTodosQueryParams = zod.object({
  "completed": zod.boolean().optional().describe('完了済みタスクのみ取得する場合はtrue、未完了のみはfalse。指定なしは全て。'),
  "limit": zod.number().min(1).max(getTodosQueryLimitMax).default(getTodosQueryLimitDefault),
